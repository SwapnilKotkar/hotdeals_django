              ...
              <div className="container-lg p-0 m-2 row d-flex justify-content-center ">  
                <div className="w-100 col-12 col-sm-10 col d-flex flex-wrap justify-content-between p-0">
                  <div className="col-lg-2 col-6 pt-2 pt-sm-0 d-flex justify-content-start order-2 order-sm-2">
                    <div className="col-5 d-flex justify-content-start align-items-center"><button className='btn btn-outline-primary text-capitalize text-primary rounded-3 border-1 d-flex justify-content-center align-items-center' style={{backgroundColor:"#E4FBFF"}}>Hot</button></div>
                    <div className="col-5 d-flex  justify-content-start align-items-center"><button className='btn btn-outline-primary text-capitalize text-primary rounded-3 border-1 d-flex justify-content-center align-items-center' style={{backgroundColor:"#E4FBFF"}}>New</button></div>
                  </div>
                  <div className="dropdown col-lg-1 col-md-2 col-sm-2 col-3 order-2 order-sm-2 d-flex justify-content-end pt-2 pt-sm-0">
                  ...
                  <div className="col-lg-6 col-12 p-0 d-flex justify-content-start align-items-center order-1 order-sm-2">
                ...
                <div className="view-btn col-lg-2 col-6 d-flex justify-content-center align-items-center order-2 order-sm-2 mt-2 mt-sm-0 p-0">
